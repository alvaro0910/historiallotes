            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="text" id="direccion" name="direccion" placeholder="Dirección" class="form-control" value="{{ $data->direccion }}"><small class="help-block text-muted">Ingrese la dirección de la finca</small></div>
                    </div>     
                </div>

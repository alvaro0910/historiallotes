                ...
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Cultivo</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="cultivo" name="cultivo" placeholder="Cultivo" class="form-control"><small class="form-text text-muted">Ingrese el nombre del cultivo</small></div>
                        </div>
                        <div class="row form-group">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm">
                        <i class="fa fa-dot-circle-o"></i> Crear cultivo
                    </button>
                    {{ Form::close() }}

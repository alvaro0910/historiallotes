            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="text" id="periodo" name="periodo" placeholder="Fecha" class="form-control" value="{{ $data->periodo }}">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="text" id="cantidadmo" name="cantidadmo" placeholder="Cantidad MO" class="form-control" value="{{ $data->cantidadmo }}">

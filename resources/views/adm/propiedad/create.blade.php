            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="text" id="material" name="material" placeholder="Material" class="form-control"><small class="form-text text-muted">Ingrese el material</small></div>
                    </div>
                    <div class="row form-group">

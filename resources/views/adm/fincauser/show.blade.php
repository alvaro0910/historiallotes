                        ...
                        <section class="card">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    <i class="fa fa-envelope-o"></i> <b>Usuario ID:</b> {{ $data{'0'}->user_id }} 
                                </li>
                                <li class="list-group-item">
                                    <i class="fa fa-envelope-o"></i> <b>Nombre usuario:</b> {{ $data{'0'}->name }} 
                                </li>
                                <li class="list-group-item">
                                    <i class="fa fa-envelope-o"></i> <b>Finca ID:</b> {{ $data{'0'}->finca_id }} 
                                </li>
                                <li class="list-group-item">
                                    <i class="fa fa-envelope-o"></i> <b>Nombre finca:</b> {{ $data{'0'}->nombre }} 
                                </li>
                                <li class="list-group-item">
                                ...
                                <li class="list-group-item">
                                    ...
                                    <a href="{{ route('fincasusers.edit', $data{'0'}->id) }}"> 
                                        <div class="icon-container" style="width:240px;">
